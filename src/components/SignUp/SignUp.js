...
const UserForm = ({ history }) => {
    ...
    const submitHandler = useCallback(event => {
        ...
        dispatch(actions.auth(authForm.name.value, authForm.email.value, authForm.password.value, authForm.ConfirmPassword.value));
        dispatch(actions.authLogin(authForm.email.value, authForm.password.value));
    }, [ dispatch, authForm.name.value, authForm.email.value, authForm.password.value, authForm.ConfirmPassword.value]);
        ...
        <div style={{ backgroundColor: '#f1f1f1' }}>
            ...
            <div className={classes.Container}>
                ...
                <div className={classes.Vector}>
                    <img src={IMG} alt='vector' style={{ width: '500px', height: '588px' }} />
                </div>
...
export default (withErrorHandler(UserForm));